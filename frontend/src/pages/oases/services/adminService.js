...
export const assignmentService = {
  assign: (payload) =>
    oasesAxios.post('/assignment/assign', payload).then((r) => r.data.data),

  list: (params = {}) =>
    oasesAxios.get('/assignment', { params }).then((r) => r.data.data),
};

export const conflictService = {
  list: (params = {}) =>
    oasesAxios.get('/conflict', { params }).then((r) => r.data.data),

  getDetail: (sheetId) =>
    oasesAxios.get(`/conflict/${sheetId}`).then((r) => r.data.data),
...
export const auditService = {
  ...
  list: (params = {}) =>
    oasesAxios.get('/audit', { params }).then((r) => r.data.data),
