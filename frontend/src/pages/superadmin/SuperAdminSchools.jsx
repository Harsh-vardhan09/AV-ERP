...
import { useGetAllSchoolsQuery, useCreateSchoolMutation, useToggleSchoolStatusMutation, useDeleteSchoolMutation, useUpdateSchoolMutation } from '../../redux/api/superAdminApi';
