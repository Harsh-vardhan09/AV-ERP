  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-base font-semibold text-gray-900">Student Fee Status</h2>
          <p className="text-xs text-gray-400 mt-0.5">View and manage individual student fee records</p>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4 flex flex-wrap gap-3 items-end shadow-sm">
        ...
        <div>
          <label className="block text-xs text-gray-400 uppercase tracking-wide mb-1">Status</label>
          <select
            value={statusFilter}
            onChange={e => { setStatus(e.target.value); setPage(1); }}
            className="border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-emerald-400"
          >
