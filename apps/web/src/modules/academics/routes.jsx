...
export const academicsRoutes = [
  ...
  { path: 'teacher/assignments', lazy: page(() => import('./pages/TeacherAssignments')), handle: { roles: TEACHER } },
...
export const academicsLegacyRoutes = [
  ...
  { path: '/assignment', lazy: page(() => import('./pages/assignments/Assignmentpage')), handle: { roles: STUDENT } },
  { path: '/assignment/:subject', lazy: page(() => import('./pages/assignments/AssignmentsDetails')), handle: { roles: STUDENT } },
  { path: '/assignment/:subject/:assignmentid', lazy: page(() => import('./pages/assignments/SubmissionPage')), handle: { roles: STUDENT } },
];
