...
import { useGetReportTemplatesQuery, useGetTemplateForClassQuery, useGetTemplateSelectionQuery } from '../api/reportTemplateApi';
import { authHeaders } from '@shared/lib/authHeader';
...
const TemplateReportCard = () => {
  // Same auth query RouteGuard reads the role from
