...
const main = async () => {
  ...
  console.log(
    `✅ Step 3: Academic Session — ${sesCreated ? 'Created' : 'Exists'}: ${session.name}`
  );

  // STEP 4: Classes (9 & 10)
  const { doc: class9 } = await upsert(
    ClassModel,
    { name: 'Class 9', session: session._id, schoolId: school._id },
    { name: 'Class 9', numericOrder: 9, session: session._id, schoolId: school._id }
  );
  ...
  const { doc: sec9A } = await upsert(
    SectionModel,
    { name: 'Section A', classId: class9._id, session: session._id, schoolId: school._id },
    { name: 'Section A', classId: class9._id, session: session._id, schoolId: school._id }
  );
  const { doc: sec10A } = await upsert(
    SectionModel,
  ...
  const studentDataRaw = [
    // Class 9
    {
      email: 's9_1.sps@school.com',
      firstName: 'Aarav',
      lastName: 'Gupta',
      rollNo: '901',
      studentId: 'SSPS-9-001',
      scholarNo: 'SCH9001',
    ...
    {
      email: 's9_2.sps@school.com',
      firstName: 'Sneha',
      lastName: 'Sharma',
      rollNo: '902',
      studentId: 'SSPS-9-002',
      scholarNo: 'SCH9002',
    ...
    {
      email: 's9_3.sps@school.com',
      firstName: 'Rohan',
      lastName: 'Verma',
      rollNo: '903',
      studentId: 'SSPS-9-003',
      scholarNo: 'SCH9003',
    ...
    {
      email: 's9_4.sps@school.com',
      firstName: 'Pooja',
      lastName: 'Singh',
      rollNo: '904',
      studentId: 'SSPS-9-004',
      scholarNo: 'SCH9004',
    ...
    {
      email: 's9_5.sps@school.com',
      firstName: 'Vikram',
      lastName: 'Patel',
      rollNo: '905',
      studentId: 'SSPS-9-005',
      scholarNo: 'SCH9005',
    ...
    // Class 10
    {
      email: 's10_1.sps@school.com',
      firstName: 'Arjun',
      lastName: 'Kumar',
      rollNo: '1001',
      studentId: 'SSPS-10-001',
      scholarNo: 'SCH10001',
      dob: new Date('2009-04-10'),
      cls: class10,
      sec: sec10A,
      admNo: 'SPS-10-001',
    },
    {
      email: 's10_2.sps@school.com',
      firstName: 'Divya',
      lastName: 'Mehta',
      rollNo: '1002',
      studentId: 'SSPS-10-002',
      scholarNo: 'SCH10002',
      dob: new Date('2009-08-25'),
      cls: class10,
      sec: sec10A,
      admNo: 'SPS-10-002',
    },
    {
      email: 's10_3.sps@school.com',
      firstName: 'Manish',
      lastName: 'Yadav',
      rollNo: '1003',
      studentId: 'SSPS-10-003',
      scholarNo: 'SCH10003',
      dob: new Date('2009-12-14'),
      cls: class10,
      sec: sec10A,
      admNo: 'SPS-10-003',
    },
    {
      email: 's10_4.sps@school.com',
      firstName: 'Kavya',
      lastName: 'Tiwari',
      rollNo: '1004',
      studentId: 'SSPS-10-004',
      scholarNo: 'SCH10004',
      dob: new Date('2009-06-03'),
      cls: class10,
      sec: sec10A,
      admNo: 'SPS-10-004',
    },
    {
      email: 's10_5.sps@school.com',
      firstName: 'Suresh',
      lastName: 'Joshi',
      rollNo: '1005',
      studentId: 'SSPS-10-005',
      scholarNo: 'SCH10005',
      dob: new Date('2009-02-19'),
      cls: class10,
      sec: sec10A,
      admNo: 'SPS-10-005',
    },
  ...
  for (const sd of studentDataRaw) {
    ...
    const { doc: sp } = await upsert(
      ...
      { userId: u._id, schoolId: school._id },
      {
        ...
        scholarNo: sd.scholarNo,
        rollNo: sd.rollNo,
        dateOfBirth: sd.dob,
        gender: 'male',
        classId: sd.cls._id,
        sectionId: sd.sec._id,
        session: session._id,
        address: 'School Road, Indore',
        city: 'Indore',
        state: 'MP',
        pincode: '452001',
