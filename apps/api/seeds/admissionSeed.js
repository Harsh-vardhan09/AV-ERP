  ...
  try {
    ...
    const demoStudents = [
      ...
      },
      {
        firstName: 'Sneha',
        lastName: 'Agarwal',
        email: 'sneha.agarwal@school.com',
        rollNo: 'STU009',
        admissionNumber: 'ADM2025009',
        gender: 'female',
      ...
      },
      {
        firstName: 'Vivaan',
        lastName: 'Chauhan',
        email: 'vivaan.chauhan@school.com',
        rollNo: 'STU010',
        admissionNumber: 'ADM2025010',
        gender: 'male',
    ...
    for (const s of demoStudents) {
      ...
      console.log(
        `✅ Student created: ${s.firstName} ${s.lastName} (${s.class}-${s.section}) → ${s.email}`
      );
      created++;
    }
