// Seeds the root Super Admin. Password must come from --password or SEED_SUPERADMIN_PASSWORD
...
if (!SA_PASSWORD) {
  console.error('❌  A password is required — there is no default.');
  console.error('    Pass --password "<strong-password>" or set SEED_SUPERADMIN_PASSWORD');
  process.exit(1);
}
