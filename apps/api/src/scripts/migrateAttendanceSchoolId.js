/**
 * Migration Script: Populate schoolId in existing Attendance records
 * 
 * This script finds all Attendance records without schoolId and populates them
 * based on the session's schoolId.
 * 
 * Run with: node src/scripts/migrateAttendanceSchoolId.js
 */
