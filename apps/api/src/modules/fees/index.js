...
//
// Getters, not eager requires: the services pull in the fee models plus src-old
...
module.exports = {
  ...
  get studentFeeService() { return require('./services/studentFeeService'); },

  // FeeReceipt — consumer: src-old/controller/adminController (dashboard receipts).
  ...
  get FeeReceipt() { return require('./models/FeeReceipt').FeeReceipt; },

  // ReceiptCounter — no consumer outside the module yet; exported beside FeeReceipt
  // so the pair stays discoverable together
  get ReceiptCounter() { return require('./models/FeeReceipt').ReceiptCounter; },

  // StudentFee — consumer: src-old/controller/adminController (fee summary tile)
  get StudentFee() { return require('./models/StudentFee'); },
};
