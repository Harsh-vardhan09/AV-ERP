...
exports.requestRefund = async (req, res) => {
    try {
        ...
        return serviceError(res, "requestRefund error:", error);
    }
};
...
exports.approveRefund = async (req, res) => {
    try {
        ...
        return serviceError(res, "approveRefund error:", error);
    }
};
...
exports.rejectRefund = async (req, res) => {
    try {
        ...
        return serviceError(res, "rejectRefund error:", error);
    }
};
...
exports.processRefund = async (req, res) => {
    try {
        ...
        return serviceError(res, "processRefund error:", error);
    }
};
...
exports.getRefundsByPayment = async (req, res) => {
    try {
        ...
        return serviceError(res, "getRefundsByPayment error:", error);
    }
};
...
exports.getRefundsByAccountFee = async (req, res) => {
    try {
        ...
        return serviceError(res, "getRefundsByAccountFee error:", error);
    }
};
