...
} = require("../services/accountFeeService");
...
exports.assignAccountFee = async (req, res) => {
    try {
        ...
        return serviceError(res, "assignAccountFee error:", error);
    }
};
...
exports.getAccountFeeSummary = async (req, res) => {
    try {
        ...
        return serviceError(res, "getAccountFeeSummary error:", error);
    }
};
...
exports.bulkAssignFees = async (req, res) => {
    try {
        ...
        return serviceError(res, "bulkAssignFees error:", error);
    }
};
