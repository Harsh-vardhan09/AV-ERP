...
exports.getPendingAccounts = async (req, res) => {
    try {
        ...
        const schoolBillingPeriods = await require('../models/BillingPeriod')
        ...
        return serviceError(res, "getPendingAccounts error:", error);
    }
};
...
exports.getFullyPaidAccounts = async (req, res) => {
    try {
        ...
        const schoolBillingPeriods2 = await require('../models/BillingPeriod')
            .find({ schoolId: req.schoolId }).select('_id').lean();
        ...
        return serviceError(res, "getFullyPaidAccounts error:", error);
    }
};
...
exports.getDailyCollection = async (req, res) => {
    try {
        ...
        return serviceError(res, "getDailyCollection error:", error);
    }
};
...
exports.getBillingPeriodSummary = async (req, res) => {
    try {
        ...
        return serviceError(res, "getBillingPeriodSummary error:", error);
    }
};
...
exports.getFeeDashboard = async (req, res) => {
    try {
        ...
        const schoolBPs = await require('../models/BillingPeriod')
            .find({ schoolId: req.schoolId }).select('_id').lean();
        ...
        return serviceError(res, "getFeeDashboard error:", error);
    }
};