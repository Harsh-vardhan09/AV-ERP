...
exports.getAllForms = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] getAllForms:', err.message);
...
exports.getDeletedForms = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] getDeletedForms:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.getFormById = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] getFormById:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.createForm = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] createForm:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.updateForm = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] updateForm:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.toggleFormStatus = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] toggleFormStatus:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.deleteForm = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] deleteForm:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.restoreForm = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] restoreForm:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.getFormLeads = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] getFormLeads:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.submitForm = async (req, res) => {
  try {
    ...
    logger.error('[CustomForm] submitForm:', err.message);
    res.status(500).json({ success: false, message: err.message });
  }
};
