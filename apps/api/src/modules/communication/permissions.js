// Every route in this module is gated by varifyToken only — no authorize() call
// appears in any of the four routers. These keys record that, they do not tighten it.
...
const permissions = {
  ...
  'communication.notices.create':    ANY_AUTHENTICATED,
  'communication.notices.delete':    ANY_AUTHENTICATED,
