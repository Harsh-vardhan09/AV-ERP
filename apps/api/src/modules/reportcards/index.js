...
module.exports = {
  // ReportCard — consumers: src-old/services/calculationService,
  // src-old/controller/teacherController, seeds and tools
  get ReportCard() { return require('./models/ReportCard'); },

  // ReportCardMark — consumers: src-old/services/calculationService, seeds and tools
  get ReportCardMark() { return require('./models/ReportCardMark'); },
  ...
  get ReportTemplate() { return require('./models/ReportTemplate'); },
  ...
  get TemplateParserService() { return require('./services/templateParserService'); },
  ...
  // teacherController
  get TemplateFieldExtractor() { return require('./services/templateFieldExtractor'); },

  // buildStudentData — consumer: modules/documents/documentController
  get templateEngine() { return require('./lib/templateEngine'); },

  // schemas — consumer: seeds/seedReportTemplates
  get templateSchemas() { return require('./templates/schemas'); },
};
