...
const syncMarksFromSource = async (
  ...
  if (debug) {
    ...
    logger.debug('[ReportCardDebug] Student marks count from source:', consistentMarksDocs.length);
    logger.debug('[ReportCardDebug] Marks from source:', JSON.stringify(marks, null, 2));
    logger.debug('[ReportCardDebug] Unique subjects with marks:', subjectsFromMarks);
  }
