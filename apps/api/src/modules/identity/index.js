...
module.exports = {
  ...
  // core/security/authenticate, ~40 src-old controllers, and the seed/tool scripts
   get User() { return require('./models/user').User; },
  ...
  // Consumers: modules/library, staffController, superAdminController
   get generatePassword() { return require('./lib/generatePassword'); },
