...
const permissions = {
  ...
  'examination.exams.archive': EXAM_CONTROLLER_ONLY,
  'examination.exams.restore': EXAM_CONTROLLER_ONLY,
  'examination.exams.unlock': EXAM_CONTROLLER_ONLY,
  'examination.examAuditLog.list': EXAM_CONTROLLER_ONLY,
