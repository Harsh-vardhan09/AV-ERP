...
module.exports = {
  ...
  // reportCard, student, teacher controllers and fee (razorpay, studentFee)
   get notificationService() { return require('./services/notificationService'); },
  ...
  // controllers, platformRoutes and payroll's payslipService
   get emailService() { return require('./lib/emailService'); },
  ...
  // transport. Consumer: modules/identity/controllers/otpController
   get mailtrap() { return require('./lib/mailtrap'); },
  ...
  // teacher controllers and fee's studentFeeController
   get emailTemplates() { return require('./lib/emailTemplates'); },

  // scheduleNotifications. Consumer: src-old/controller/adminController
   get scheduleNotifications() { return require('./lib/scheduleNotifications'); },
};
