// ── Repair script: process sheets with empty pageImages ──────────
// Run with: node scripts/repairSheets.js
// Finds all AnswerSheets with processingStatus pending/failed AND
// empty pageImages array, then calls processAnswerSheet for each.
...
async function main() {
  ...
  const { processAnswerSheet } = require('../src/services/oases/pdfService');
