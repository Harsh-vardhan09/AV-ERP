/**
 * seedHMHSS00022FormConfig.js
 * ─────────────────────────────────────────────────────────────────────────────
 * One-time seed: writes the ordered registration-form field config for school
 * code HMHSS00022 into the AdmissionFormSettings collection.
 *
 * Usage:
 *   node seedHMHSS00022FormConfig.js
 *
 * The field order & labels exactly match the physical form shown in ss1 & ss2.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
const AdmissionFormSettings = require('./src/models/AdmissionFormSettings');
