/**
 * seedMaster.js — Complete ERP Master Seed
 * Seeds ALL data needed to test every module end-to-end.
 *
 * Run from backend folder:  node seedMaster.js
 * IDEMPOTENT — safe to run multiple times, no duplicate errors.
 */
...
const seedMaster = async () => {
  ...
  const SubjectMaster           = require('./src/models/SubjectMaster');
  const TeacherProfile          = require('./src/models/TeacherProfile');
  const StudentProfile          = require('./src/models/StudentProfile');
  const ClassSubjectMap         = require('./src/models/ClassSubjectMap');
  const ClassTeacherAssignment  = require('./src/models/ClassTeacherAssignment');
  const TeacherSubjectAssignment= require('./src/models/TeacherSubjectAssignment');
  const FeeHead                 = require('./src/models/fee/FeeHead');
  const FeeStructure            = require('./src/models/fee/FeeStructure');
  const StudentFee              = require('./src/models/fee/StudentFee');
  const Installment             = require('./src/models/fee/Installment');
  const LedgerEntry             = require('./src/models/fee/LedgerEntry');
  const Payment                 = require('./src/models/fee/Payment');
  const FeeSession              = require('./src/models/fee/Session');
  const BillingPeriod           = require('./src/models/fee/BillingPeriod');
  const AccountFee              = require('./src/models/fee/AccountFee');
  ...
  const studentFeeMap = {};
  try {
    const { assignFeeToStudent } = require('./src/services/fee/studentFeeService');
