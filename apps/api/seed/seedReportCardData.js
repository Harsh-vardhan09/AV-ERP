/**
 * seedReportCardData.js — Report Card Module Full Seed (v2)
 *
 * Seeds complete, realistic, relational dummy data so ALL THREE dashboards
 * (Admin, Teacher, Student) work end-to-end for the Report Card module.
 *
 * KEY FIXES in v2:
 *  - Co-scholastic skill names now EXACTLY match the controller's defaults
 *  - TeacherProfile + ClassTeacherAssignment + TeacherSubjectAssignment seeded
 *  - Student dashboard login (roll-number based) works out of the box
 *  - Fully idempotent (upsert pattern — safe to run multiple times)
 *
 * Login credentials seeded:
 *   Admin   : admin@school.com        / admin123      school: DEMO2025
 *   Teacher : rc_teacher@school.com   / teacher123    school: DEMO2025
 *   Student : roll number 01–12       / student123    school: DEMO2025
 *             (or email rc_s01@school.com … rc_s12@school.com)
 *
 * Run from the backend folder:
 *   node scripts/seedReportCardData.js
 */
