/**
 * Seed script — creates a demo school + admin user directly in MongoDB.
 * Run: node seedSchool.js
 *
 * This bypasses the HTTP API so no PLATFORM_SECRET is needed.
 * Safe to re-run — skips creation if the school code already exists.
 */
