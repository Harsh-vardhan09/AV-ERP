/**
 * OASES Users Seed Script
 * Creates demo users for all 4 OASES roles (SCAN_OPERATOR, EVALUATOR, HEAD_EXAMINER, SCHOOL_ADMIN)
 * Run: node src/scripts/seedOasesUsers.js
 */
