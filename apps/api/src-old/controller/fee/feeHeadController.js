...
exports.createFeeHead = async (req, res) => {
    try {
        ...
        if (error.name === 'ValidationError') {
            ...
            logger.error('createFeeHead validation error', { message, schoolId: req.schoolId });
...
exports.getAllFeeHeads = async (req, res) => {
    try {
        ...
        logger.error('getAllFeeHeads error', { error: error.message, schoolId: req.schoolId });
        return sendError(res, 500, 'Internal server error');
    }
};
...
exports.updateFeeHead = async (req, res) => {
    try {
        ...
        logger.error('updateFeeHead error', { error: error.message, schoolId: req.schoolId });
        return sendError(res, 500, 'Internal server error');
    }
};
...
exports.deleteFeeHead = async (req, res) => {
    try {
        ...
        logger.error('deleteFeeHead error', { error: error.message, schoolId: req.schoolId });
        return sendError(res, 500, 'Internal server error');
    }
};
