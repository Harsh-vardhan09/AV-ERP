...
exports.createFeeStructure = async (req, res) => {
    try {
        ...
        logger.error('createFeeStructure error', { error: error.message, schoolId: req.schoolId });
...
const backfillFeesForClass = async (classId, sessionId, className, schoolId) => {
    try {
        ...
        console.log(`[FeeBackfill] Assigning fees to ${toAssign.length} student(s) in class "${className}"...`);
        ...
        logger.error('[FeeBackfill] Error', { error: err.message });
    }
};
...
exports.getFeeStructureById = async (req, res) => {
    try {
        ...
        logger.error('getFeeStructureById error', { error: error.message, schoolId: req.schoolId });
        return sendError(res, 500, 'Internal server error');
    }
};
...
exports.updateFeeStructure = async (req, res) => {
    try {
        ...
        logger.error('updateFeeStructure error', { error: error.message, schoolId: req.schoolId });
        return sendError(res, 500, 'Internal server error');
    }
};
...
exports.deleteFeeStructure = async (req, res) => {
    try {
        ...
        logger.error('deleteFeeStructure error', { error: error.message, schoolId: req.schoolId });
        return sendError(res, 500, 'Internal server error');
    }
};
