...
exports.createTemplate = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] Create error:', err);
...
exports.getTemplates = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] GetAll error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.getTemplate = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] GetOne error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.updateTemplate = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] Update error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.deleteTemplate = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] Delete error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.extractFields = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] ExtractFields error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.previewTemplate = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] Preview error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.previewSavedTemplate = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] previewSavedTemplate error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.generatePDF = async (req, res) => {
  ...
  try {
    ...
    logger.error('[AdmissionTemplate] GeneratePDF error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.setDefault = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] SetDefault error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.cloneTemplate = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] Clone error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
...
exports.getActiveTemplate = async (req, res) => {
  try {
    ...
    logger.error('[AdmissionTemplate] GetActive error:', err);
    return res.status(500).json({ success: false, message: err.message });
  }
};
