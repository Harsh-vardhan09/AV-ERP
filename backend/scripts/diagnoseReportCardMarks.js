/**
 * diagnoseReportCardMarks.js
 * ─────────────────────────────────────────────────────────────────────────────
 * Run this script to diagnose why marks for certain exams (e.g., Half-Yearly)
 * are not appearing in the report card.
 *
 * Usage:
 *   node scripts/diagnoseReportCardMarks.js <studentUserId> [sessionId]
 *
 * Example:
 *   node scripts/diagnoseReportCardMarks.js 6612abc123 6612session456
 *
 * You can also set STUDENT_USER_ID and SESSION_ID as env vars.
 */
