/**
 * clearReportCardData.js — Remove Report Card Dummy Data
 *
 * Deletes ONLY the records that were created by seedReportCardData.js.
 * Identifies them by matching the specific emails / admission numbers /
 * exam names used in that script — nothing else is touched.
 *
 * Run from the backend folder:
 *   node scripts/clearReportCardData.js
 */
