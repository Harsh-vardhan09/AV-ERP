 ...
 * backfillSchoolId.js
 * ─────────────────────────────────────────────────────────────────────────────
 * One-time migration: stamps schoolId onto all documents that are missing it.
 *
 * HOW TO RUN:
 *   node scripts/backfillSchoolId.js --schoolId=<ObjectId> --collection=<name>
 *
 * EXAMPLES:
 *   node scripts/backfillSchoolId.js --schoolId=66251abc... --collection=sessions
 *   node scripts/backfillSchoolId.js --schoolId=66251abc... --collection=billingperiods
 *   node scripts/backfillSchoolId.js --schoolId=66251abc... --collection=assignments
 *   node scripts/backfillSchoolId.js --schoolId=66251abc... --collection=knowledgecenters
 *
 * SAFETY:
 *   ✅ Only updates documents WHERE schoolId does NOT already exist
 *   ✅ Uses updateMany with $exists: false — never overwrites existing values
 *   ✅ Logs count before and after
 *   ✅ Dry-run mode: add --dry to preview without writing
 */
...
const MODEL_MAP = {
  sessions:         () => require('../src/models/fee/Session'),
  billingperiods:   () => require('../src/models/fee/BillingPeriod'),
  assignments:      () => require('../src/models/assignment'),
  knowledgecenters: () => require('../src/models/knowledgecenter'),
};
