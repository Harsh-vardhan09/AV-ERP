// ══════════════════════════════════════════════════════════════════
// OASES Model — EvaluationMark (Sprint 3 — full)
...
const { EVAL_ROUNDS } = require('../../utils/oasesConstants');
...
const QuestionMarkSchema = new mongoose.Schema(
  {
    ...
    marksGiven:   { type: Number, default: 0 },           // Sprint 3: renamed from marksAwarded
    isNA:         { type: Boolean, default: false },
    stepMarks:    { type: [StepMarkSchema], default: [] }, // Sprint 3: per-step breakdown
    annotation:   { type: String, default: '' },
    savedAt:      { type: Date,   default: Date.now },     // Sprint 3: per-question save timestamp
  },
  { _id: false }
);
...
const EvaluationMarkSchema = new mongoose.Schema(
  {
    ...
    savedAt:      { type: Date, default: null }, // Sprint 3: last auto-save timestamp
