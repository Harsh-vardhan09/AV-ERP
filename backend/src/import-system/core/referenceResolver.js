...
class ReferenceResolver {
  ...
  async resolveReference(refName, values, refConfig, schoolId) {
    ...
    try {
      switch (refName) {
        ...
        default:
          console.warn(`[ReferenceResolver] Unknown ref type: ${refName}`);
      }
    } catch (err) {
      console.error(`[ReferenceResolver] Error resolving ${refName}:`, err.message);
    }
    return result;
  }
  ...
  async resolveSessions(names, schoolId, config = {}) {
    ...
    try {
      ...
      console.error('[ReferenceResolver] resolveSessions error:', err.message);
      return [];
    }
  }
  ...
  async resolveClasses(names, schoolId, config = {}) {
    ...
    try {
      ...
      console.error('[ReferenceResolver] resolveClasses error:', err.message);
      return [];
    }
  }
  ...
  async resolveSections(names, schoolId, config = {}) {
    ...
    try {
      ...
      console.error('[ReferenceResolver] resolveSections error:', err.message);
      return [];
    }
  }
