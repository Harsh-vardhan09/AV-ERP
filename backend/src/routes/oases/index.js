...
// Sprint 7: rate limiters
const { generalOasesLimiter } = require('../../middlewares/oasesRateLimiter');
...
const moderateRoutes   = require('./moderateRoutes');  // Sprint 5: HE panel
const reportRoutes     = require('./reportRoutes');    // Sprint 6: reports
...
// ── Sprint 7: Apply general limiter to all authenticated routes ───
