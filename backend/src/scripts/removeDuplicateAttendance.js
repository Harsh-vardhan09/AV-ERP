/**
 * Script to identify and remove duplicate Attendance records
 * This script finds records with the same classId, sectionId, subjectId, date, attendanceType
 * and keeps only the most recent one
 * 
 * Run with: node src/scripts/removeDuplicateAttendance.js
 */
